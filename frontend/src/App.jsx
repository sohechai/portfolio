  ...
  const mouseMove = (e) => {
    ...
    if (hoveredLink) {
      const { left, top, width, height } =
        hoveredLink.current.getBoundingClientRect();
      ...
      const { left, top, width, height } =
        hoveredLogo.current.getBoundingClientRect();
      ...
      const { left, top, width, height } =
        hoveredSquare.current.getBoundingClientRect();
      ...
      <div className="header">
        <div className="logo">
          <a href="#home" id="mix">
            <Magnetic>
              <span
                className="boundsLogo"
                ref={homeRef}
                onMouseOver={() => handleMouseOver(homeRef)}
            ...
            <a href="#timeline" id="mix">
              <Magnetic>
                <span
                  className="bounds"
                  ref={aboutRef}
                  onMouseOver={() => handleMouseOver(aboutRef)}
            ...
            <a href="#work" id="mix">
              <Magnetic>
                <span
                  className="bounds"
                  ref={projectsRef}
                  onMouseOver={() => handleMouseOver(projectsRef)}
                  onMouseOut={handleMouseOut}
                ></span>
                PROJECTS
              </Magnetic>
            ...
            <a href="#skills" id="mix">
              <Magnetic>
                <span
                  className="bounds"
                  ref={skillsRef}
                  onMouseOver={() => handleMouseOver(skillsRef)}
                  onMouseOut={handleMouseOut}
                ></span>
                SKILLS
              </Magnetic>
            ...
            <a href="#contact" id="mix">
              <Magnetic>
                <span
                  className="bounds"
                  ref={contactRef}
                  onMouseOver={() => handleMouseOver(contactRef)}
                  onMouseOut={handleMouseOut}
                ></span>
                CONTACT
              </Magnetic>
